      ...
      <div className="AboutmeContent">
        ...
        <div className="AboutmeText">
          <p className="AboutmeParagraph">
            I am a creative Full Stack Software Engineer eager to get new
            challenges and learn new things ! If you are currently seeking a
            self-motivated and detail-oriented Web Developer, with the capacity
            to learn in a fast-paced environment and adapt quickly to different
            points of view, that's precisely what I'm prepared to bring to the
            table.
          </p>
          <p className="AboutmeParagraph">
          ...
          <p className="AboutmeParagraph">
            ...
            development and I am looking forward to continuing to perfect my
            skills as I complete great projects. I enjoy interacting with
            different teams and putting myself in other people's shoes to
            maximize the user experience and implementation of the designer’s
            ideas.
          </p>
        </div>
      </div>
